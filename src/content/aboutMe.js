...
export const texts = [
    'Hey congrats for navigating this far in my KDE-neon inspired React website! ',
    'A bit about me - I\'m Nayman, a Masters of Engineering student specializing '
    + 'in Computing Systems (Hardware Logic Design, System-on-Chip, Design Verification). '
    ...
    + 'actively looking for full-time positions in those focus areas. ',
    ...
    + 'in the \'projects directory\' and my Github repo for the actual code!',
    'PS: For those who appreciate Linux or those who want to play around with a terminal, '
    + 'go ham on it after you close this thing!',
];
